                ...
                >
                    ...
                    <div className="p-8">
                        ...
                        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <button className="w-full bg-gradient-to-r from-brand-primary to-purple-600 hover:from-brand-primary hover:to-purple-700 text-white font-bold py-3.5 rounded-xl transition-all shadow-md hover:shadow-lg hover:shadow-indigo-500/25 mt-6">
